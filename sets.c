...
static bool Search_Set(const Set_Node in,const void *key,float (*compare)(const void *,const void *)){
	if(in==NULL)
		return false;
...
static bool delete_root(Set *in){
	bool l,r;
...
static bool delete_child(Set_Node parent,Set_Node child,bool which){
	bool l,r;
...
// Union Operation
static void Set_Union(Set *to,const Set_Node current_from,size_t size,float (*compare)(const void *,const void *)){
...
static void set_intersect(Set *add,Set to,const Set_Node current_from,size_t size,float (*compare)(const void *,const void *)){
	if(current_from==NULL)
		return;
...
// Set Difference
static void set_diff(Set *source,const Set_Node current_from,float (*compare)(const void *,const void *)){
	if(current_from==NULL)
		return;
